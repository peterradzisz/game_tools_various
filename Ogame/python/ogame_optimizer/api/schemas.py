...
class ShipCounts(BaseModel):
    ...
    def validate_ships(cls, v: Dict[str, int]) -> Dict[str, int]:
        valid = {"small_cargo", "large_cargo", "light_fighter", "heavy_fighter", "cruiser", "battleship", "battlecruiser", "bomber", "destroyer", "deathstar", "pathfinder", "recycler", "espionage_probe"}
