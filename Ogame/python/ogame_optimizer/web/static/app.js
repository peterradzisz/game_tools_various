  ...
  form.addEventListener("submit", async function(e) {
    ...
    try {
      ...
      var payload = {
        ...
        optimization_target: (document.getElementById('optimization_target')||{value:'minimize_loss'}).value || 'minimize_loss',
...
var SHIP_NAME_MAP = {
  ...
  "pathfinder": "pathfinder", "recycler": "recycler",
};
...
var UNSUPPORTED = ["reaper", "crawler", "interceptor", "ion bomber"];
